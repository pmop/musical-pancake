  ...
  _createClass(_default, [{
    ...
    value: function logData(e) {
      var newOpts = e.map(function (e) {
        ...
        el.text = e.street; //console.log(el)
        //`<option value="${e.postal_code}">${e.street}</option>`

        return el;
      });
      var streetSel = document.getElementById('street-selector');
      streetSel.replaceChildren.apply(streetSel, _toConsumableArray(newOpts)); //this.citySelectTarget.append(newOpts)
    }
  }, {
...
/******/ });
//# sourceMappingURL=application-6f0cb46b4376c173e7b3.js.map