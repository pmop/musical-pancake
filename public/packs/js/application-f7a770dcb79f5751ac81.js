  ...
  _createClass(_default, [{
    ...
    value: function logData(e) {
      var newOpts = e.map(function (e) {
        return "<option value=\"".concat(e.postal_code, "\"> + ").concat(e.street, " + </option>");
      });
      var el = document.getElementById('street-selector');
      console.log(Object.keys(el)); //this.citySelectTarget.children().remove()
...
/******/ });
//# sourceMappingURL=application-f7a770dcb79f5751ac81.js.map