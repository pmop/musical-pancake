  ...
  _createClass(_default, [{
    ...
    value: function logData(e) {
      var newOpts = e.map(function (e) {
        ...
        el.text = e.street; //console.log(`<option value="${e.postal_code}">${e.street}</option>`)

        console.log(el);
        return el;
      });
      var streetSel = document.getElementById('street-selector');
      streetSel.options = newOpts; //this.citySelectTarget.append(newOpts)
    }
  }, {
...
/******/ });
//# sourceMappingURL=application-0d65e586f8164aff16e5.js.map