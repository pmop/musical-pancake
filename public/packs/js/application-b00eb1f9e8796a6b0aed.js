  ...
  _createClass(_default, [{
    ...
    value: function logData(e) {
      var newOpts = e.map(function (e) {
        ...
        //console.log(el)
        //return el
        "<option value=\"".concat(e.postal_code, "\">").concat(e.street, "</option>");
      });
      var streetSel = document.getElementById('street-selector');
      streetSel.innerHTML = newOpts.join(''); //this.citySelectTarget.append(newOpts)
    }
  }, {
...
/******/ });
//# sourceMappingURL=application-b00eb1f9e8796a6b0aed.js.map